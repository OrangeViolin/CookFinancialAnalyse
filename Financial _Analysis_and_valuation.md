...
如何估计未来收益？预测报表的整体流程如下：

![](https://ws1.sinaimg.cn/large/006tNc79ly1g5rzdkfck5j30fz0bzafa.jpg)

整个过程，模拟企业正常经营过程。

第一个轮子，经营活动的预测。

1 营业收入是和市场互动最直接的环节，收入水平=公司自己战略的决策+市场决定的。可能市场很大但只占有市场很小的份额；可能公司想要扩大收入的规模，但市场由于竞争的存在如法实现收入的规模。

234 经营成本费用，资产方面的投资增加资产，为了满足投资需要资金的融资是哪些，用于支撑这些收入规模。
...
6 现金流量表要基于利润表和资产负债表去预测。

其中，营业收入的预测和长期投资的预测是最难的。


## 2.1 经营活动的预测

1 营业收入，艺术的成本比较多，行业的理解，战略的了解。因此就假设，去年一个亿，今年就定 10%。

2 成本和费用，用上一年成本和费用的结构来预测，成本和费用占收入的比重是相对稳定的。成本 75%，营业费用和管理费用 5%

3 资产周转率，收入和资产的比值关系，要完成收入规模的规划，需要多大规模的资产来支撑。根据历史资产周转率进行这个部分的预测

4 增加的资产是这个企业需要通过一定途径满足资金需要，当一个企业的收入规模变大之后，采购也会增加，应付账款也会增加，预收款也会增加，第四个步骤要分成两个部分，流动负债除了短期借款之外，都和经营活动相关，经营活动相关的流动负债，引入负债的周转率，收入或者成本和负债的比值来衡量。剩余的就是公司需要通过融资解决的负债。
